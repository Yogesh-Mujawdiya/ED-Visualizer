...
@Component({
  selector: 'app-vigenere-cipher-decryption',
  templateUrl: './vigenere-cipher-decryption.component.html',
  styleUrls: ['./vigenere-cipher-decryption.component.css']
})
export class VigenereCipherDecryptionComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<VigenereCipherDecryptionComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData) {
      ...
      for(let i=0;i<this.PlainText.length;i++){
        ...
        if(this.PlainText[i]>="A" && this.PlainText[i]<="Z"){
          ...
          this.PlainTextMatrix[i][4] = (this.PlainTextMatrix[i][2]-this.PlainTextMatrix[i][3]+26)%26;
