...
@Component({
  selector: 'app-x-or-cipher-encryption',
  templateUrl: './x-or-cipher-encryption.component.html',
  styleUrls: ['./x-or-cipher-encryption.component.css']
})
export class XOrCipherEncryptionComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<XOrCipherEncryptionComponent>,
